  ...
  const steps = [
    {
      ...
      hindi: 'किसान पंजीकरण एवं आधार सत्यापन',
      desc: 'Verify mobile number and link Aadhaar or Kisan Credit Card (KCC) once to activate your digital procurement profile and verified bank account.',
      icon: UserCheck,
      ...
      cropTag: 'Kisan ID Verification',
      mockVisual: {
        screenTitle: 'Kisan ID Verification',
        line1: 'Farmer: Balwinder Singh (Kisan ID: PB-8821)',
        line2: 'Aadhaar: •••• •••• 4912 (UIDAI Verified)',
        line3: 'Bank Account: SBI •••• 9814 (Active DBT Link)',
        status: 'Identity Verified & Ready'
      }
    },
    {
      stepNumber: '02',
      title: 'Select Crop Commodity & Expected Weight',
      shortTitle: 'Crop & Weight',
      hindi: 'फसल व मात्रा चयन (MSP लॉक)',
      desc: 'Pick your harvested crop (Wheat, Paddy, Mustard, Maize) and enter expected yield in quintals. View the official locked MSP government rate.',
      icon: Wheat,
      ...
      cropTag: 'Wheat / गेहूं • Rabi 2026',
      mockVisual: {
        screenTitle: 'Commodity Selection',
        line1: 'Crop: Wheat / गेहूं (Grade A Rabi 2026)',
        line2: 'Government MSP: ₹2,425 / Quintal',
        line3: 'Estimated Weight: 60 Quintals',
        status: 'MSP Rate Locked: ₹1,45,500'
      }
    },
    {
      stepNumber: '03',
      title: 'Choose Nearest Mandi & Delivery Window',
      shortTitle: 'Mandi Slot',
      hindi: 'नजदीकी मंडी व समय स्लॉट चयन',
      desc: 'Select your preferred local grain depot and pick a convenient calendar date with an allocated 1-hour gate arrival slot to eliminate all queues.',
      icon: Building2,
      ...
      mockVisual: {
        screenTitle: 'Mandi Arrival Slot',
        line1: 'Centre: Khanna Main Grain Mandi',
        line2: 'Date: 22 March 2026 (Reserved)',
        line3: 'Gate Window: 10:30 AM - 11:30 AM',
        status: 'Guaranteed Dock Allocation'
      }
    },
    {
      stepNumber: '04',
      title: 'Instant QR Token & Digital Gate Pass',
      shortTitle: 'QR Pass',
      hindi: 'डिजिटल टोकन व QR गेट पास',
      desc: 'Your unique encrypted token and QR pass are generated instantly. Saved on your phone and sent to your mobile via SMS and WhatsApp.',
      icon: QrCode,
      badge: 'Step 4: QR Pass',
      ...
      cropTag: 'Token #SP-7892',
      mockVisual: {
        screenTitle: 'Gate Pass SP-7892',
        line1: 'Token Number: #SP-7892',
        line2: 'Vehicle: PB-10-CZ-4412 (Tractor + Trolley)',
        line3: 'QR Security: Anti-Tamper 256-bit Code',
        status: 'Ready to Scan at Mandi Gate'
      }
    },
    {
      stepNumber: '05',
      title: 'Express Entry & Electronic Weighbridge',
      shortTitle: 'Weighbridge',
      hindi: 'सीधा प्रवेश व इलेक्ट्रॉनिक तौल',
      desc: 'Arrive at your scheduled time. The gate operator scans your QR code in 5 seconds. Drive directly onto the electronic weighbridge with zero queue.',
      icon: Truck,
      badge: 'Step 5: Mandi Weigh-in',
      accentColor: 'from-red-600 to-orange-600',
      badgeBg: 'bg-red-500/15 text-red-700 dark:text-red-300 border-red-400/40',
      tagColor: 'border-red-600 text-red-600 dark:text-red-400',
      cropTag: '60.00 Qtl Net Crop',
      mockVisual: {
        screenTitle: 'Weighbridge Gross & Tare Scan',
        line1: 'Gate Queue: 0 Minutes Wait',
        line2: 'Gross Weight: 8,420 kg (Tractor + Wheat)',
        line3: 'Tare Weight: 2,420 kg (Empty Tractor)',
        status: 'Net Crop: 6,000 kg (60.00 Quintals)'
      }
    },
    {
      stepNumber: '06',
      title: 'Instant Digital J-Form & Direct Bank Payout',
      shortTitle: 'Bank DBT',
      hindi: 'डिजिटल जे-फॉर्म व सीधा बैंक भुगतान',
      desc: 'Receive your verified digital J-Form procurement receipt instantly. Full Minimum Support Price (MSP) is credited straight to your bank account.',
      icon: CreditCard,
      badge: 'Step 6: Direct Payout',
      ...
      mockVisual: {
        screenTitle: 'Direct Benefit Transfer (DBT)',
        line1: 'Procurement Slip: J-FORM-2026-9901',
        line2: 'Total MSP Amount: ₹1,45,500',
        line3: 'Bank Settlement: Dispatched via PFMS',
                      ...
                      >
                        ...
                        <div className="space-y-3 font-mono text-xs">
                          ...
                          >
                            ...
                            <div className="font-bold text-sm text-slate-800 dark:text-neutral-200 mt-0.5">
                          ...
                          >
                            <div className="text-[10px] uppercase font-bold text-slate-400 dark:text-neutral-500">Step Detail 03</div>
                            <div className="font-bold text-sm text-slate-800 dark:text-neutral-200 mt-0.5">
                              {current.mockVisual.line3}
                            </div>
                          </div>

                          <div className={`p-3 rounded-xl bg-gradient-to-r ${current.accentColor} text-white flex items-center justify-between shadow-md`}>
