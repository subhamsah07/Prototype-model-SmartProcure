        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-18 flex items-center justify-between">
          ...
          */}
          <div className="hidden md:flex items-center gap-2 lg:gap-2.5">
            ...
            {/* 4. Admin Login Section with Official Login Button */}
            <div className="flex items-center gap-1.5 p-1 rounded-xl bg-slate-100 dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800">
              ...
              <Link to="/admin/login">
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg transition-colors cursor-pointer ${
                    darkMode
                      ? 'bg-neutral-800 text-slate-200 hover:text-emerald-400 hover:bg-neutral-700'
                      : 'bg-white text-slate-800 hover:text-emerald-800 hover:bg-slate-50 shadow-2xs'
                  }`}
                >
              ...
              {/* Official Login Button (UI Only) */}
              <button
                type="button"
                onClick={() => setOfficialModalOpen(true)}
                className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-bold rounded-lg bg-emerald-700 hover:bg-emerald-800 text-white transition-colors cursor-pointer shadow-2xs"
                title="Department & Mandi Official Sign In"
              >
            ...
            {/* 5. Help Button (with dropdown: Contact Us + Feedback) */}
            <div className="relative">
              <button
                type="button"
                onClick={() => {
          ...
          >
            ...
            <div className="pt-2 flex flex-col gap-2.5 border-t border-slate-200 dark:border-neutral-800">
              ...
              <button
                ...
                className="w-full py-2.5 px-3 rounded-lg text-xs font-bold text-white bg-emerald-700 hover:bg-emerald-800 flex items-center justify-center gap-2"
              >
                <UserCheck className="h-4 w-4" />
                <span>Official Login (Mandi Staff)</span>
              </button>
